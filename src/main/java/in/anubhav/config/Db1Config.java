...
@EnableJpaRepositories(
		basePackages = "in.anubhav.db1.jpa",  // ✅ repository package for DB1
...
public class Db1Config {
	...
	@ConfigurationProperties(prefix = "spring.datasource.db1") // db properties from app.props config
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource)
				.packages("in.anubhav.db1.entity") // ✅ your entity package
				.persistenceUnit("db1")
				 .properties(Map.of(
